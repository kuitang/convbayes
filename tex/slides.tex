...
\begin{frame}
  ...
  \begin{itemize}
  \item Hacked BVLC's Caffe's predifined Caffenet model (found in Model Zoo)
...
\begin{frame}
  ...
  \begin{itemize}
  \item Extracted and clearned Wikipedia pages for Imagenet synsets (928 found)
  \item Cleaned and stemmed words, only included those in Google News Corpus
  \item Ran LDA, implemented in gensim, over corpus with the following results:
  \item Model 1:
  \item 20  Topics, Perplexity: 194.5
